...
e_sgmt_pos <- enricher(gene_pos_tail_list$SYMBOL, TERM2GENE=sgs, pvalueCutoff = 0.01, pAdjustMethod = "BH", universe=names(geneList_HUGO), minGSSize = 10, maxGSSize = 900, qvalueCutoff = 0.01)
e_sgmt_neg <- enricher(gene_neg_tail_list$SYMBOL, TERM2GENE=sgs, pvalueCutoff = 0.01, pAdjustMethod = "BH", universe=names(geneList_HUGO), minGSSize = 10, maxGSSize = 900, qvalueCutoff = 0.01)
if ( nrow(e_sgmt_pos)>0 )
{
